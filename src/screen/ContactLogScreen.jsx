...
import CallLogs from 'react-native-call-log'; // Ensure this import is correct
...
const ContactLogsScreen = () => {
  ...
  const markAsSuspicious = async (phoneNumber) => {
    ...
    if (user) {
      try {
        // Check if the number exists in the verifiedContacts collection
